...
public class Menu extends JFrame implements ActionListener{
    private JMenuBar mb;
    private JMenu menuOptions, menuAbout, menuWallpaper;
    private JMenuItem myLatam, myBlack, myPurple, myCreator, myExit, myNew;
    ...
    public Menu(){
        ...
        myBlack.setForeground(new Color(0,0,0));
        ...
        comboDepto.setForeground(new Color(0,0,0));
        add(comboDepto);
        comboDepto.addItem("");
        ...
        labelLabor = new JLabel("Antiguedad Laboral: ");
        ...
        comboLabor.setForeground(new Color(0,0,0));
        add(comboLabor);
        comboLabor.addItem("");
        comboLabor.addItem("1 año de servicio");
        comboLabor.addItem("2 a 6 años de servicio");
        comboLabor.addItem("7 o mas años de servico");


        labelResult = new JLabel("Resultado Vacaciones: ");
        ...
        button1.setBounds(50,392,100,30);/////////////////////////////////////////////////
    ...
    public void actionPerformed(ActionEvent ev) {
        if (ev.getSource() == button1){
            ...
            if(name.equals("") || L1.equals("") || L2.equals("") || Depto.equals("") || Labor.equals("")){
                ...
                if(Depto.equals("Atencion al Pasajero")){
                    if(Labor.equals("1 año de servicio")){
                        textArea1.setText("\n  El trabajador " + name + " " + L1 + " " + L2 + 
                                          "\n quien trabaja en el area de " + Depto + " con " + Labor + 
                                          "\n tiene derecho a 15 dias de vacaciones.");
                    }
                    if(Labor.equals("2 a 6 años de servicio")){
                        textArea1.setText("\n  El trabajador " + name + " " + L1 + " " + L2 + 
                                          "\n quien trabaja en el area de " + Depto + " con " + Labor + 
                                          "\n tiene derecho a 17 dias de vacaciones.");
                    }
                    if(Labor.equals("7 o mas años de servico")){
                        textArea1.setText("\n  El trabajador " + name + " " + L1 + " " + L2 + 
                                          "\n quien trabaja en el area de " + Depto + " con " + Labor + 
                ...
                if(Depto.equals("Rampa")){
                    if(Labor.equals("1 año de servicio")){
                        textArea1.setText("\n  El trabajador " + name + " " + L1 + " " + L2 + 
                                          "\n quien trabaja en el area de " + Depto + " con " + Labor + 
                                          "\n tiene derecho a 16 dias de vacaciones.");
                    }
                    if(Labor.equals("2 a 6 años de servicio")){
                        textArea1.setText("\n  El trabajador " + name + " " + L1 + " " + L2 + 
                                          "\n quien trabaja en el area de " + Depto + " con " + Labor + 
                                          "\n tiene derecho a 18 dias de vacaciones.");
                    }
                    if(Labor.equals("7 o mas años de servico")){
                        textArea1.setText("\n  El trabajador " + name + " " + L1 + " " + L2 + 
                                          "\n quien trabaja en el area de " + Depto + " con " + Labor + 
                ...
                if(Depto.equals("Gerencia")){
                    ...
                    if(Labor.equals("7 o mas años de servico")){
                        textArea1.setText("\n  El trabajador " + name + " " + L1 + " " + L2 + 
                                          "\n quien trabaja en el area de " + Depto + " con " + Labor + 
                                          "\n tiene derecho a 25 dias de vacaciones.");
                    }
        ...
        if (ev.getSource() == myCreator){
            JOptionPane.showMessageDialog(null, "Desarrollado por Marcelo Morales \n"+
